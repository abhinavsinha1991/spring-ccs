...
public class CCSServiceUnavailableException extends Exception
{
    ...
    public CCSServiceUnavailableException( String message, Throwable cause, HttpStatus status )
    {
        super( message, cause );
    ...
    public CCSServiceUnavailableException( String message , HttpStatus status )
    {
        super( message );
        this.status = status.value();
    ...
    public CCSServiceUnavailableException( Throwable cause, HttpStatus status )
    {
        super( cause );
